...
public class Player
{
    ...
    private const float MoveSpeed = 320f;   // скорость по X
    ...
    public void Update(GameTime gameTime, LevelManager manager, bool debug)
    {
        ...
        */
        ...
        var newPos = _position + _velocity * dt;
        var playerRect = GetPlayerRect(newPos);
        ...
        foreach (var platform in platforms)
        {
            ...
            if (playerRect.Intersects(platformRect))
            {
                ...
                var tryYRect = GetPlayerRect(new Vector2(_position.X, newPos.Y));
    ...
    public void TakeDamage(int amount)
    {
        ...
        else
        {
            ...
            Push(new Vector2(-3 * MoveSpeed, -400));
        }
    }
    ...
    public void Respawn(float invincibilityTimer = 1f)
    {
        _health = _maxHealth;
        _velocity = Vector2.Zero;
        _position = _initPosition;   // стартовая позиция
